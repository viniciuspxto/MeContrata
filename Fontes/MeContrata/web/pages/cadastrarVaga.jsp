						...
						<div class="corpoCadastro">
							...
							<form class="form-group" action="">
								<div class="row">
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<label class="control-label" for="nome">Pré-requisitos</label>
										<textarea class="form-control" rows="3"></textarea>
									</div>
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<label class="control-label" for="nome">Benefícios</label>
										<textarea class="form-control" rows="3"></textarea>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
										<label class="control-label" for="nomeVaga">Data Início Processo</label>
										<input type="date" name="nomeVaga" class="form-control">
									</div>
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
										<label class="control-label" for="nomeVaga">Data Final Processo</label>
										<input type="date" name="nomeVaga" class="form-control">
									</div>
								</div>
							</form>
							<div class="row">
								...
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 direita">
									<button class="btn btnVerdeAcao verde" data-toggle="modal" data-target="#cadastroVagaSuc">Cadastrar</button>
								</div>
							</div>
						</div>
					</div>
